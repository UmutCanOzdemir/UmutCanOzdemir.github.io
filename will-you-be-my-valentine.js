let messages = ["Lütfenn?", "Hem Eskiden Beğenmiştim!", "Benim Kadar Gülüyosun Bence Sendee?", "Bi Daha Düşün!", "Emin Misinnn!", "Bi Daha Beğenmemm!"];
let noCount = 0;
...
function acceptLove() {
    document.getElementById("valentine").innerHTML = `
        ...
        <div class="question">KABUL EDECEĞİNİ BİLİYODUMMMMM</div>
    `;
    launchConfetti();
    startHeartRain();
}
